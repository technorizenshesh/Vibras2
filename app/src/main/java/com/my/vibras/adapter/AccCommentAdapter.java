...
public class AccCommentAdapter extends RecyclerView.Adapter<AccCommentAdapter.StoriesViewHolder> {

    private Context context;

    RestrauntCommentItemBinding binding;

    private List<AccomadListResSuccess.Result> commentList;

    public AccCommentAdapter(Context context, List<AccomadListResSuccess.Result> commentList)
    {
