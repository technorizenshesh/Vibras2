...
public class PostRestaurentFragment extends Fragment {
    ...
    private final String restrantName="";
    private String strLocation="";
    private final String strDetails="";
    private final String edt_contact="";
    private String myLatitude = "",myLongitude="";

    private VibrasInterface apiInterface;
    private static final int AUTOCOMPLETE_REQUEST_CODE = 55;
    private String status;

    private final ArrayList<SuccessResGetCategory.Result> categoryResult = new ArrayList<>();

    private final ArrayList<String> eventsCategories = new ArrayList<>();

    private final ArrayList<String> eventsType = new ArrayList<>();
...
/*  binding.rlAdd.setOnClickListener(v ->
   ...
   binding.rlAdd.setOnClickListener(v ->
    ...
    void showProducts() {
      ...
      */
/*  Log.e("", "SizeSizeSizeSizeSizeSize:  showProducts" );
        List<String> ids = Collections.singletonList("vibes_add_restra"); // your product IDs

        List<QueryProductDetailsParams.Product> productList = null;
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.N) {
            productList = ids.stream().map(productId ->
 ...
 */
/* QueryProductDetailsParams.Product.newBuilder()
                        .setProductId("createrestrabasicvibras")
                        .setProductType(BillingClient.ProductType.SUBS)
                        .build());*//*
        ...
        billingClient.queryProductDetailsAsync(params, (billingResult, list) -> {
            ...
            try {
                ...
                for (int i = 0; i < list.size(); i++) {
                    Log.e(TAG, "SizeSizeSizeSizeSizeSize " + list.get(i).getName());
                    Log.e(TAG, "SizeSizeSizeSizeSizeSize " + list.get(i).getDescription());
                    Log.e(TAG, "SizeSizeSizeSizeSizeSize " + list.get(i).getProductId());
                    Log.e(TAG, "SizeSizeSizeSizeSizeSize " + list.get(i).getProductType());
                    Log.e(TAG, "SizeSizeSizeSizeSizeSize " + list.get(i).getTitle());
                    Log.e(TAG, "SizeSizeSizeSizeSizeSize " + list.get(i).getSubscriptionOfferDetails());
...
*//*
        ...
        List<String> skuList = Collections.singletonList("createrestrabasicvibras");
        ...
        billingClient.queryProductDetailsAsync(params, (billingResult, productDetailsList) -> {
            // handle response
            Log.e(TAG, "SizeSizeSizeSizeSizeSize " + productDetailsList.size());
            Log.e(TAG, "SizeSizeSizeSizeSizeSize " +billingResult.getResponseCode());
            Log.e(TAG, "SizeSizeSizeSizeSizeSize " +billingResult.getDebugMessage());
            Log.e(TAG, "SizeSizeSizeSizeSizeSize " +billingResult.toString());
...
//      Application of the Array to the Spinner
    ...
    public void showImageSelection() {
        ...
        LinearLayout layoutGallary = dialog.findViewById(R.id.layoutGallary);
...
//                        Navigation.findNavController(v).navigate(R.id.action_addAddressFragment_to_currentLocationFragment);
    ...
    void showProducts() {
        ...
        ImmutableList<QueryProductDetailsParams.Product> productList = ImmutableList.of(
                //Product 1
                QueryProductDetailsParams.Product.newBuilder()
                        .setProductId("vibras_add_restra")
                        .setProductType(BillingClient.ProductType.SUBS)
                        .build());
        QueryProductDetailsParams params = QueryProductDetailsParams.newBuilder()
                .setProductList(productList)
