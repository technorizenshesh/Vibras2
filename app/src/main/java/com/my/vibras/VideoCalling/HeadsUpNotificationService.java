...
public class HeadsUpNotificationService extends Service implements MediaPlayer.OnPreparedListener  {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        int NOTIFICATION_ID= Integer.parseInt(getString(R.string.default_notification_channel_id));
        try {
...
try {
    ...
    e.printStackTrace();
        ...
        try {
            ...
            Log.e("TAG", "call_typecall_typecall_typecall_typecall_typecall_type------: "+callType );
          ...
          /*  receiveCallPendingIntent = PendingIntent.getBroadcast(AppController.getContext(),
            ...
            if (data != null) {
                ...
                notificationBuilder = new NotificationCompat.Builder(this, CHANNEL_ID)
                        .setContentTitle(StringEscapeUtils.unescapeJava(name))
                        .setAutoCancel(false)
