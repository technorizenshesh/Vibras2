...
public class LikeSentActivity extends AppCompatActivity {
    ...
    private void getAllUsers(String userId) {
        ...
        DataManager.getInstance().showProgressMessage(LikeSentActivity.this, getString(R.string.please_wait));

        Map<String, String> map = new HashMap<>();
        map.put("user_id", userId);
        Call<SuccessFollowersRes> call = apiInterface.get_following(map);
            ...
            public void onResponse(Call<SuccessFollowersRes> call, Response<SuccessFollowersRes> response) {
                ...
                try {
                    ...
                    if (data.getStatus().equals("1")) {
                        ...
                        mAdapter = new LikeRecivedAdapter(LikeSentActivity.this, usersList);
                        binding.rvFrnd.setHasFixedSize(true);
                        // use a linear layout manager
                        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(
                                LikeSentActivity.this);
                        ...
                        showToast(LikeSentActivity.this, data.getMessage());
                    }
                } catch (Exception e) {
                    e.printStackTrace();
                }
